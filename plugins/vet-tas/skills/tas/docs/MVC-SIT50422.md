...
**Meridian Vocational College** &middot; RTO 45039 &middot; CRICOS 03551M &middot; Diploma &middot; 30 weeks

> **The other institute delivers this qualification too, from its own strategy.** See `ACI-SIT50422`. The two hold SEPARATE registers: their elective selections and their delivery orders differ, and a different elective set changes which unit owns a shared topic. Never read one register for the other.


28 units - 11 core plus 17 electives. 28 units are recorded; **5 are delivered**.
Learners arrive from **MVC-SIT40521**; units marked *credit-transfer* below are already held and are not taught here.
...
- The TAS unit table types SITXFIN010 as SITXFIN0010. Corrected against training.gov.au and recorded in titleCorrections.
...
**Why here.** SITXCCS016 Develop and manage quality customer service practices is the unit that WRITES the standard, and it is delivered second. SITXCCS015 Enhance customer service experiences, delivered fifth, works to that standard. The two detected families - professional service standards, and the attitudes and attributes expected by the industry - are one topic: what good service looks like and who is expected to deliver it.

**What the other units do.** SITXCCS015 opens by naming the standard set in SITXCCS016 and moves immediately to its own ground: reading an individual customer, anticipating a need, and recovering a service failure in the moment.
...
**Why here.** Delivered first, SITXFIN010 Prepare and monitor budgets must treat a restructure as a factor that moves a budget. SITXCCS016 later treats the same restructure as a factor that dates a customer service policy. The event is one thing and is explained once.
